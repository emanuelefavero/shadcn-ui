...
function DealsAndRevenue() {
  return (
    <>
      <Card className='animation-slide-in-right max-w-[500px] w-full rounded-xl overflow-hidden bg-purple-900 bg-opacity-5 py-6 px-5 hidden 2xxs:flex flex-col justify-between'>
        <h2
